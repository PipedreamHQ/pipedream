...
export default {
  ...
  props: {
    ...
    jobStartDate: {
      ...
      description: "The start date of the job (YYYY-MM-DD format)",
    },
    contractStartDate: {
      type: "string",
      label: "Contract Start Date",
      description: "The contract start date (YYYY-MM-DD format)",
      optional: true,
    },
    contractEndDate: {
      type: "string",
    ...
    billingDate: {
      type: "string",
      label: "Billing Date",
      description: "The billing date (YYYY-MM-DD format)",
      optional: true,
    },
    salaryAmount: {
      type: "integer",
