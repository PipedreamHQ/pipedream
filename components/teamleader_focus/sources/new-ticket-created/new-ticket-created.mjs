...
export default {
  ...common,
  key: "teamleader_focus-new-ticket-created",
  name: "New Ticket Created (Instant)",
  description: "Emit new event for each ticket created. [See the documentation](https://developer.focus.teamleader.eu/docs/api/webhooks-register)",
  version: "0.0.1",
  type: "source",
  dedupe: "unique",
  methods: {
