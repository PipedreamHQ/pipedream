...
export default {
  ...
  description: "Create a tag in a workspace. [See documentation here](https://developers.google.com/tag-platform/tag-manager/api/v2/reference/accounts/containers/workspaces/tags/create)",
  type: "action",
  props: {
    app,
    accountId: {
