// legacy_hash_id: a_vgippa
import { axios } from "@pipedream/platform";

export default {
  key: "mautic-update-contact",
  name: "Update Contact",
  description: "Updates a contact, and depending of the requests method, creates a new contact.",
  version: "0.1.1",
  type: "action",
  props: {
    mautic: {
  ...
  async run({ $ }) {
  //See the API docs at: https://developer.mautic.org/#edit-contact

    if (!this.contact_id || !this.http_method) {
      throw new Error("Must provide contact_id, and http_method parameters.");
    }

    return await axios($, {
      method: this.http_method,
      url: `${this.mautic.$auth.mautic_url}/api/contacts/${this.contact_id}/edit`,
      headers: {
