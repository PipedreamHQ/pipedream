...
module.exports = {  
  ...
  props: {
    ...
    as_user: { propDefinition: [ slack, "as_user" ], description: "Pass true to update the message as the authed user. Bot users in this context are considered authed users." },
