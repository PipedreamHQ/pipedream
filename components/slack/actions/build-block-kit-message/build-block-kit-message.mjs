export default {
  name: "Build Block Kit Message (Beta)",
  version: "0.0.1",
  key: "slack-build-block-kit-message",
  description: "Build a custom Slack message using their Block Kit API. This action will export an array of blocks that you can pass to the Send Block Kit Message action. [See the documentation](https://api.slack.com/tools/block-kit-builder).",
  props: {
    blockType: {
      type: "string",
      label: "Block Type",
