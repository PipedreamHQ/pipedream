...
export default {
  ...
  name: "Get Thread",
  description: "Retrieves a single thread's metadata, including status, assignee, associations, and latest-message info. [See the documentation](https://developers.hubspot.com/docs/api-reference/conversations-conversations-inbox-&-messages-v3/public-thread/get-conversations-v3-conversations-threads-threadId)",
  version: "0.0.1",
  type: "action",
  annotations: {
