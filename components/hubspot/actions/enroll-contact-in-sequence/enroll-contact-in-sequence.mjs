...
export default {
  ...
  description: "Enroll a contact into a HubSpot sequence. [See the documentation](https://developers.hubspot.com/docs/api-reference/legacy/automation/sequences/enroll-contact)",
  version: "0.0.1",
  annotations: {
