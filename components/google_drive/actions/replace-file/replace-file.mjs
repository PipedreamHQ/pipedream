...
export default {
  ...
  name: "Replace File",
  description: "Upload a file that replaces an existing file. [See the documentation](https://developers.google.com/drive/api/v3/reference/files/update) for more information",
  version: "0.1.3",
  type: "action",
  props: {
    googleDrive,
