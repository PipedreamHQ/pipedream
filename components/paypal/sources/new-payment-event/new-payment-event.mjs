...
export default {
  ...
  description: "Emit new event on an new payment webhook event. [See webhooks docs here](https://developer.paypal.com/docs/api/webhooks/v1/#webhooks_post) and [Events Types docs here](https://developer.paypal.com/docs/api/webhooks/v1/#webhooks-event-types_list)",
  type: "source",
  dedupe: "unique",
  props: {
    ...common.props,
