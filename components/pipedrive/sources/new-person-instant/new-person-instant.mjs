...
export default {
  ...
  description: "Emit new event when a new person is created in Pipedrive, via a webhook registered on the connected account. Each event is the Pipedrive webhook (v2) payload: `meta` (`action`, `entity`, `entity_id`, `timestamp`, `user_id`) and `data` (the new person). Custom fields in `data` are keyed by their 40-character field hash. Use **Get person details** to fetch the full record. [See the documentation](https://developers.pipedrive.com/docs/api/v1/Webhooks#addWebhook)",
  version: "0.0.19",
  type: "source",
  dedupe: "unique",
  methods: {
