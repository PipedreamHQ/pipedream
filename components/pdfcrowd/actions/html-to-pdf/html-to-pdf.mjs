  ...
  additionalProps() {
    ...
    return {
      ...
      dataString: {
        type: "string",
        label: "Data String",
        description: "Set the input data for template rendering. The data format can be JSON,...",
        optional: true,
      },
      dataFormat: {
        type: "string",
        label: "Data Format",
        description: "Specify the input data format. Use `\"auto\"` for automatic detection...",
        options: [
          "auto",
          "json",
          "xml",
      ...
      dataIgnoreUndefined: {
        ...
        description: "Ignore undefined variables in the HTML template. The default mode is...",
        optional: true,
      },
      dataAutoEscape: {
        type: "boolean",
        label: "Data Auto Escape",
        description: "Auto escape HTML symbols in the input data before placing them into the...",
        optional: true,
      },
      dataTrimBlocks: {
        type: "boolean",
      ...
      dataOptions: {
        type: "string",
        label: "Data Options",
        description: "Set the advanced data options:`csv_delimiter` - The CSV data delimiter,...",
        optional: true,
      },
      debugLog: {
        type: "boolean",
