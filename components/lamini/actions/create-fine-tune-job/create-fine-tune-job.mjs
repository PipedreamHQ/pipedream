...
export default {
  ...
  props: {
    ...
    uploadFilePath: {
      ...
      description: "Base path to in Lamini platform where the training dataset is stored. Eg. `/app/lamini/datasets/90fbaa189be247d13044792a6b5b3690a5756ea9d01a59a9a9116601c2dd9b6f.jsonlines`.",
      optional: true,
    },
    fineTuneArgs: {
      type: "object",
