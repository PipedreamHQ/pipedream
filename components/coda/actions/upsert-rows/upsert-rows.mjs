...
export default {
  ...
  props: {
    ...
    rows: {
      ...
      description: "List of rows objects to create. Example: `[{\"cells\":[{column:\"<columnId>\",value:\"<value>\"}]}]`. More information at [Coda API](https://coda.io/developers/apis/v1#operation/upsertRows)",
    },
  },
  async run() {
    let data = {
