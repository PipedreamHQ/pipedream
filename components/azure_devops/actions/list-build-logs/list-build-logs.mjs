...
export default {
  ...
  description: "List a build's log files, each with its id, line count and the url to fetch its content. Use this to locate the log for a failing step before fetching it. Example: build `4821` returns 3 logs. [See the documentation](https://learn.microsoft.com/en-us/rest/api/azure/devops/build/builds/get-build-logs?view=azure-devops-rest-7.1)",
  version: "0.0.1",
  type: "action",
  annotations: {
