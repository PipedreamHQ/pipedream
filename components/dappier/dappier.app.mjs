...
export default {
  ...
  propDefinitions: {
    ...
    startDate: {
      type: "string",
      label: "Start Date",
      description: `Inclusive start of the reporting window in \`YYYY-MM-DD\` format, interpreted as **UTC** (e.g. \`2026-08-01\`). Optional - when omitted, defaults to 6 days before the End Date (a trailing 7-day window). The window between Start Date and End Date must not exceed ${MAX_ANALYTICS_RANGE_DAYS} days.`,
      optional: true,
    },
    endDate: {
      type: "string",
