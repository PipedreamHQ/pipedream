...
export default {
  ...
  propDefinitions: {
        ...
        const {
          ...
          data: {
            ...
            pagination_parameters: {
              page_size: constants.DEFAUL_LIMIT,
              cursor,
            },
          },
        });
    ...
    startTime: {
      type: "string",
      label: "Start Time",
      description: "The start time in **ZonedDateTime** format. Eg. `2023-08-03T10:15:30-07:00[America/Los_Angeles]`. [See the documentation](https://developer.nextdoor.com/reference/advertising-data-types).",
    },
    endTime: {
      type: "string",
      label: "End Time",
      description: "The end time in **ZonedDateTime** format. Eg. `2023-08-03T10:15:30-07:00[America/Los_Angeles]`. [See the documentation](https://developer.nextdoor.com/reference/advertising-data-types).",
    },
    adGroupId: {
      type: "string",
      label: "Ad Group ID",
