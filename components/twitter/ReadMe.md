<p align="center">
    <img width="80" height="80" src="/images/twitter/Generic_Feed-icon.svg.png">    </p>
<h1 align="center"><strong>RSS for Hackers</strong></h1>

<p align="center">Patterns for processing and producing RSS feeds</p>

<p align="center">
    <a alt="Getting Started" href="#getting-started"><img width="30%" src="/images/twitter/GettingStarted.png"></a>
    <a alt="Example Worksflows" href="#example-workflows"><img width="30%" src="/images/twitter/Workflows.png"></a>
    <a "SSE + REST API" href="#sse-and-rest-apis"><img width="30%" src="/images/twitter/RestApi.png"></a>
</p>
...
<p align="center">
    <img width="100%" src="/images/twitter/pipedream.png">
</p>
