...
export default {
  ...
  description: "Emit new events when replies are added to product reviews. Polls every 15 minutes.",
  version: "0.0.1",
  type: "source",
  dedupe: "unique",
  methods: {
    ...
    async fetchItems(since) {
      const result = await this.trustpilot.getProductReviews(this.getPollingParams(since));
