...
export default {
  ...
  props: {
    ...
    apiKey: {
      ...
      description:
        "Subscribe to [API4AI Alcohol Label Recognition](https://rapidapi.com/api4ai-api4ai-default/api/alcohol-label-recognition/pricing) on the RapidAPI hub to obtain an API Key.",
    },
    image: {
