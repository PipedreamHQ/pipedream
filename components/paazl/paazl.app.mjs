...
export default {
  ...
  propDefinitions: {
    ...
    consigneeLocale: {
      ...
      description: "Language of email templates for track & trace notifications (e.g., `en_US`)",
      optional: true,
    },
    addressCity: {
      type: "string",
    ...
    shippingOption: {
      ...
      description: "A shipping option's Paazl identifier. You will find a list of the identifiers of the shipping options available to your webshop in your webshop account under **Carriers > Shipping options** of shipping options. Eg. `FEDEX_EXPRESS_SAVER_SERVICE_DEFAULT`",
    },
    shippingContract: {
      type: "string",
