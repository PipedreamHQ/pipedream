export default {
  ...
  SECTORS: [
    ...
    { value: "ecommerce-infrastructure", label: "E-commerce Infra" },
  ...
  SIGNAL_TYPES: [
    { value: "Deploy frequency spike", label: "Deploy Frequency Spike" },
    { value: "Framework migration", label: "Framework Migration" },
    { value: "Infrastructure buildout", label: "Infrastructure Buildout" },
    { value: "Engineering hiring burst", label: "Engineering Hiring Burst" },
  ],
};
