...
export default {
  key: "apifreaks-post-pdf-png",
  name: "Convert PDF to PNG",
  description: "This API converts a given PDF file into a sequence of PNG images. [See the documentation](https://apifreaks.com/docs).",
  version: "0.0.1",
  type: "action",
  props: {
    app,
  ...
  async run({ $ }) {
    ...
    $.export("$summary", "Successfully executed Convert PDF to PNG");
    return response;
  },
};
