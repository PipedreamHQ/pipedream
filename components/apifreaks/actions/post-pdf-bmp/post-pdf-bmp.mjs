...
export default {
  key: "apifreaks-post-pdf-bmp",
  name: "Convert PDF to BMP",
  description: "Converts a PDF file to a BMP image. [See the documentation](https://apifreaks.com/docs).",
  version: "0.0.1",
  type: "action",
  props: {
    app,
  ...
  async run({ $ }) {
    ...
    $.export("$summary", "Successfully executed Convert PDF to BMP");
    return response;
  },
};
