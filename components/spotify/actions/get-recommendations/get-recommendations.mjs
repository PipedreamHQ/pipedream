...
export default {
  ...
  props: {
    ...
    seedArtists: {
      ...
      type: "string[]",
      label: "Seed Artists",
      description: "An array of Spotify IDs for seed artists. Up to 5 seed values may be provided in any combination of `seedArtists`, `seedTracks` and `seedGenres`.",
      withLabel: false,
      optional: true,
    },
    seedGenres: {
    ...
    seedTracks: {
      ...
      type: "string[]",
      label: "Seed Tracks",
      description: "An array of Spotify IDs for a seed track. Up to 5 seed values may be provided in any combination of `seedArtists`, `seedTracks` and `seedGenres`.",
      withLabel: false,
      optional: true,
    },
    limit: {
