...
export default {
  ...
  props: {
    ...
    coordinateJson: {
      ...
      description: "Optional JSON object parsed and sent as `coordinate`. Example: `{\"latitude\":37.7749,\"longitude\":-122.4194}`.",
      optional: true,
    },
    geoAddressJson: {
      type: "string",
      label: "Geo Address JSON",
      description: "Optional JSON object parsed and sent as `geo_address_json`. Example: `{\"type\":\"google\",\"place_id\":\"ChIJmQJIxlVYwokRLgeuocVOGVU\",\"description\":\"Lobby entrance\"}`.",
      optional: true,
    },
    registrationQuestionsJson: {
      type: "string",
      label: "Registration Questions JSON",
      description: "Optional JSON array parsed and sent as `registration_questions`. Example: `[{\"label\":\"What are you looking forward to?\",\"required\":false}]`.",
      optional: true,
    },
    feedbackEmailJson: {
      type: "string",
      label: "Feedback Email JSON",
      description: "Optional JSON object parsed and sent as `feedback_email`. Example: `{\"subject\":\"Thanks for attending!\",\"message\":\"We hope you enjoyed the event.\"}`.",
      optional: true,
    },
  },
  async run({ $ }) {
