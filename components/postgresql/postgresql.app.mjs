...
export default {
  ...
  propDefinitions: {
    ...
    rejectUnauthorized: {
      ...
      description: "If `true`, the server certificate is verified against the list of supplied CAs. If you get the error `Connection terminated unexpectedly` try to set this prop as `false`",
      default: true,
    },
  },
  methods: {
