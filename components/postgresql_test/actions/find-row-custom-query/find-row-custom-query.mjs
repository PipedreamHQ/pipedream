...
export default {
  ...
  key: "postgresql_test-find-row-custom-query",
  description:
  ...
  async run({ $ }) {
    ...
    if (!query.toLowerCase().includes("select")) {
      throw new Error(
        "Need be a `SELECT` statement query. Read more about [SELECT queries here](https://www.w3schools.com/sql/sql_select.asp)",
      );
    }
