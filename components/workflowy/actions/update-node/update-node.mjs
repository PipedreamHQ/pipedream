...
export default {
  ...
  name: "Update Node",
  description: "Updates an existing WorkFlowy node's name, note, and/or layout mode (POST /api/v1/nodes/:id). Run **Search Nodes** first to obtain the target node ID. At least one of name, note, or layout mode must be provided. Because the update endpoint only returns a status. [See the documentation](https://beta.workflowy.com/api-reference/#nodes-update).",
  version: "0.0.1",
  type: "action",
  annotations: {
    readOnlyHint: false,
