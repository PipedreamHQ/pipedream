...
export default {
  ...
  description: "Create a new unverified contact in eSputnik. For use with double opt-in implementation. User will need to verify the email to confirm their subscription.",
  version: "0.0.1",
  type: "action",
  props: {
    esputnik,
