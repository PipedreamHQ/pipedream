...
export default {
  ...
  props: {
    ...
    phoneNumber: {
      type: "string",
      label: "Phone Number",
      description: "Phone number of the called party. This number corresponds to the 2nd leg of a CallOut call. Phone number in E.164 format. e.g. (`16502223366`)",
    },
    extensionNumber: {
      type: "string",
      label: "Extension Number",
      description: "Extension number of the called party. e.g. (`103`)",
    },
  },
  async run({ $ }) {
    const {
