...
export default {
  ...
  props: {
    ...
    include_clause: {
      type: "string",
      description: "Fields to use in the select clause of the Customer data query. See query language syntax, limitations, and other specifications on [Data queries](https://developer.intuit.com/app/developer/qbo/docs/develop/explore-the-quickbooks-online-api/data-queries)",
    },
    where_clause: {
      type: "string",
      description: "Filters to use in the where clause of the Customer data query. Note: Multiple clauses (filters) are AND'd. The OR operation is not supported.",
    },
    order_clause: {
      type: "string",
      description: "The `order_clause` is for sorting the result. Include the Customer property to sort by. The default sort order is ascending; to indicate descending sort order, include DESC, for example: `Name DESC`",
      optional: true,
    },
    start_position: {
      type: "string",
    ...
    max_results: {
      type: "string",
      description: "The number of Customer entity elements in the response.",
      optional: true,
    },
    minorversion: {
      type: "string",
  ...
  async run({ $ }) {
  //See Quickbooks API docs at: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/customer#query-a-customer
    ...
    const query = `select ${this.include_clause} from Customer where ${this.where_clause}${orderClause}${startPosition}${maxResults}`;
