// legacy_hash_id: a_1Wi7KO
import { axios } from "@pipedream/platform";

export default {
  key: "quickbooks_sandbox-search-invoices",
  ...
  props: {
    ...
    order_clause: {
      type: "string",
      description: "The `order_clause` is for sorting the result. Include the Invoice property to sort by. The default sort order is ascending; to indicate descending sort order, include DESC, for example: `Name DESC`",
      optional: true,
    },
    start_position: {
      type: "string",
  ...
  async run({ $ }) {
  //See Quickbooks API docs at: https://developer.intuit.com/app/developer/qbo/docs/api/accounting/all-entities/invoice#query-an-invoice
    ...
    const query = `select ${this.include_clause} from Invoice where ${this.where_clause}${orderClause}${startPosition}${maxResults}`;
