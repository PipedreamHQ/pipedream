...
export default {
  key: "taiga-create-userstory",
  name: "Create User Story",
  description: "Create a new user story in a Taiga project. [See the documentation](https://docs.taiga.io/api.html#user-stories-create)",
  version: "0.0.1",
  type: "action",
  props: {
    taiga,
  ...
  async run({ $ }) {
    const response = await this.taiga.createUserStory({
      $,
      data: {
