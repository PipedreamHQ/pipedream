...
export default {
  ...
  description: "Creates a feedback. [See the documentation](https://app.swaggerhub.com/apis-docs/ProdPad/prodpad/1.0#/Feedback/PostFeedbacks).",
  type: "action",
  version: "0.0.2",
  props: {
    app,
    ...
    contactEmail: {
      description: "The email of the contact, it is also used to avoid duplication of contacts, it can only be filled in with `Contact Name`.",
      optional: true,
      propDefinition: [
        app,
        "email",
