...
export default {
  ...
  name: "Consultar CPF",
  description: "Returns official, real-time (D+0) registration data for a Brazilian individual (CPF) according to the selected package. Data is sourced directly from official records, never from leaked or scraped databases, under ISO/IEC <ISO_CERT> information security certification. [See the documentation](https://www.cpfcnpj.com.br/dev/)",
  version: "0.0.1",
  annotations: {
