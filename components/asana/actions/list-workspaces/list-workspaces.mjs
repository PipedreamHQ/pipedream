...
export default {
  ...
  description: "List all workspaces associated with the specified account. [See the documentation](https://developers.asana.com/reference/getworkspaces)",
  version: "0.0.1",
  type: "action",
  annotations: {
  ...
  props: {
    ...
    optFields: {
      type: "string[]",
      label: "Opt Fields",
      description: "This endpoint returns a resource which excludes some properties by default. To include those optional properties, set this query parameter to a list of the properties you wish to include (e.g. `[\"name\", \"email_domains\", \"is_organization\"]`).",
      optional: true,
      options: [
        "resource_type",
        "name",
