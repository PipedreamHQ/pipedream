...
export default {
  ...
  description: "Fetches the current trending YouTube Shorts. No query is required. [See the documentation](https://app.socialfetch.dev/playground?path=/v1/youtube/shorts/trending&method=GET)",
  version: "0.0.1",
  type: "action",
  annotations: {
