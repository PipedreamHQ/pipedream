...
export default {
  ...
  description: "Replace active order. [reference](https://bybit-exchange.github.io/docs/futuresV2/linear/#t-replaceactive)",
  props: {
    bybit,
    symbol: {
      propDefinition: [
  ...
  async run({ $ }) {
    ...
    if (returnValue.ret_code) {
      ...
      $.export("$summary", "Replace Active Order Placed Successful");
    }
    return returnValue;
  },
};
