...
export default {
  ...common,
  name: "Chat with Tools (Responses API)",
  version: "0.0.1",
  key: "openai-chat-with-tools",
  description: "Chat, using the Responses API. [See the documentation](https://platform.openai.com/docs/api-reference/responses)",
  type: "action",
  props: {
    openai,
    modelId: {
