...
export default {
  ...
  props: {
    ...
    sheetId: {
      ...
      description: "The ID of the sheet to add rows to (e.g. `1234567890123456`). Use **List Sheets** to find sheet IDs. A Smartsheet sheet URL is also accepted and resolved to the ID for you.",
    },
    rows: {
      type: "string",
      label: "Rows",
