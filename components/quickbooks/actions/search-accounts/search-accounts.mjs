...
export default {
  ...
  props: {
    ...
    order_clause: {
      type: "string",
      description: "The `order_clause` is for sorting the result. Include the Bill property to sort by. The default sort order is ascending; to indicate descending sort order, include DESC, for example: `Name DESC`",
      optional: true,
    },
    start_position: {
      type: "string",
