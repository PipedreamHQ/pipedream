...
Pipedream is an integration platform for developers. Pipedream provides a free, hosted platform for connecting apps and developing event-driven automations. You can use pre-built components to quickly connect to GitHub, Slack, Google Sheets, and more, and you can also run any Node.js, Python, Golang, or Bash code when you need custom logic.
