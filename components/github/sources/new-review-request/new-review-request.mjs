...
export default {
  ...
  description: "Emit new event for new review request notifications. [See the documentation](https://docs.github.com/en/rest/activity/notifications?apiVersion=20.2.21-28#list-notifications-for-the-authenticated-user)",
  version: "0.2.2",
  type: "source",
  dedupe: "unique",
  methods: {
