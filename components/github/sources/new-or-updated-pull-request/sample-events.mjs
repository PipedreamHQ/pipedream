export function getSampleWebhookEvent() {
  return {
    ...
    sender: {
      login: "GTFalcao",
      id: 48412907,
      node_id: "MDQ6VXNlcjQ4NDEyOTA3",
      avatar_url: "https://avatars.githubusercontent.com/u/48412907?v=4",
      gravatar_id: "",
      url: "https://api.github.com/users/GTFalcao",
      html_url: "https://github.com/GTFalcao",
      followers_url: "https://api.github.com/users/GTFalcao/followers",
      following_url:
        "https://api.github.com/users/GTFalcao/following{/other_user}",
      gists_url: "https://api.github.com/users/GTFalcao/gists{/gist_id}",
      starred_url:
        "https://api.github.com/users/GTFalcao/starred{/owner}{/repo}",
      subscriptions_url: "https://api.github.com/users/GTFalcao/subscriptions",
      organizations_url: "https://api.github.com/users/GTFalcao/orgs",
      repos_url: "https://api.github.com/users/GTFalcao/repos",
      events_url: "https://api.github.com/users/GTFalcao/events{/privacy}",
      received_events_url:
        "https://api.github.com/users/GTFalcao/received_events",
      type: "User",
      site_admin: false,
    },
  };
