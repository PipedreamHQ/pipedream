...
module.exports = {
  ...
  propDefinitions: {
    ...
    repoFullName: {
      type: "string",
      label: "Repo",
      description: "The fullname of a Github repository. It uses the convention: `owner/repo`.",
      async options({ page }) {
    ...
    events: {
      type: "string[]",
      label: "Events",
      description: "Event(s) to subscribe.",
    ...
    labelNames: {
      type: "string[]",
      label: "Labels",
      description: "String array with the names of the labels to add to the issue. Pass an empty array to remove all labels.",
      async options({
    ...
    milestone: {
      type: "string",
      label: "Milestone",
      description: "The number of the milestone associated with this issue.",
      async options({
        page, repoFullName,
      }) {
    ...
    order: {
      ...
      optional: true,
      label: "Order",
      description: "Determines whether the first search result returned is the highest number of matches (`desc`) or lowest number of matches (`asc`). This parameter is ignored `sort` if is provided. Default: `desc`.",
      options: [
        {
          label: "Descending",
          value: "desc",
