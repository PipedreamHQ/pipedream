...
- **Check Communication Capabilities** determines whether Gmail, LinkedIn, X, or Super Carl channels are ready for a target.
...
- **Get Communication** monitors a communication workflow after a draft or send.
