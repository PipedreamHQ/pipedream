...
var M = {
  ...
  alt: function (me, that) {
    ...
    var ea = that();
    return E.isLeft(ea)
      ? E.left(SE.concat(me.left, ea.left))
      : ea;
  },
};
/**
...
export var fromSum = function (tag) {
  return function (members) {
    return K.fromSum(M)(function (tag, value, keys) {
      return FS.of(DE.key(tag, DE.required, error(value, keys.length === 0
        ? "never"
 ...
 * @since 2.2.7
 */
export var draw = function (e) { return toForest(e).map(drawTree)
  .join("\n"); };
/**
 * @internal
 */
