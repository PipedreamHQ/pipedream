...
var M = {
  ...
  alt: function (me, that) {
    ...
    var ea = that();
    return E.isLeft(ea)
      ? E.left(exports.SE.concat(me.left, ea.left))
      : ea;
  },
};
/**
...
var fromSum = function (tag) {
  return function (members) {
    return K.fromSum(M)(function (tag, value, keys) {
      return FS.of(DE.key(tag, DE.required, (0, exports.error)(value, keys.length === 0
        ? "never"
...
var drawForest = function (indentation, forest) {
  ...
  for (var i = 0; i < len; i++) {
    tree = forest[i];
    var isLast = i === len - 1;
    r += indentation + (isLast
      ? "└"
      : "├") + "─ " + tree.value;
    r += drawForest(indentation + (len > 1 && !isLast
      ? "│  "
      : "   "), tree.forest);
  }
  return r;
 ...
 * @since 2.2.7
 */
var draw = function (e) { return toForest(e).map(drawTree)
  .join("\n"); };
exports.draw = draw;
/**
 * @internal
