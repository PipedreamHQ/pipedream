...
var Type = /** @class */ (function () {
  ...
  Type.prototype.pipe = function (ab, name) {
    ...
    return new Type(name, ab.is, function (i, c) {
      ...
      ? exports.identity
      : function (b) { return _this.encode(ab.encode(b)); });
  };
  /**
     * @since 1.0.0
     */
  ...
  return new DictionaryType(name, function (u) {
    ...
    if (exports.UnknownRecord.is(u)) {
      ...
      return errors.length > 0
        ? (0, exports.failures)(errors)
        : (0, exports.success)((changed
          ? a
          : u));
    }
...
var NullType = /** @class */ (function (_super) {
  ...
  function NullType() {
    var _this = _super.call(this, "null", function (u) { return u === null; }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
         */
    _this._tag = "NullType";
...
var UndefinedType = /** @class */ (function (_super) {
  ...
  function UndefinedType() {
    var _this = _super.call(this, "undefined", function (u) { return u === void 0; }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var StringType = /** @class */ (function (_super) {
  ...
  function StringType() {
    var _this = _super.call(this, "string", function (u) { return typeof u === "string"; }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var NumberType = /** @class */ (function (_super) {
  ...
  function NumberType() {
    var _this = _super.call(this, "number", function (u) { return typeof u === "number"; }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var BigIntType = /** @class */ (function (_super) {
  ...
  function BigIntType() {
    var _this = _super.call(this, "bigint",
      ...
      function (u) { return typeof u === "bigint"; }, function (u, c) { return (_this.is(u)
        ? (0, exports.success)(u)
        : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var BooleanType = /** @class */ (function (_super) {
  ...
  function BooleanType() {
    var _this = _super.call(this, "boolean", function (u) { return typeof u === "boolean"; }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var AnyArrayType = /** @class */ (function (_super) {
  ...
  function AnyArrayType() {
    var _this = _super.call(this, "UnknownArray", Array.isArray, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var AnyDictionaryType = /** @class */ (function (_super) {
  ...
  function AnyDictionaryType() {
    var _this = _super.call(this, "UnknownRecord", function (u) { return u !== null && typeof u === "object" && !Array.isArray(u); }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
function literal(value, name) {
  ...
  return new LiteralType(name, is, function (u, c) { return (is(u)
    ? (0, exports.success)(value)
    : (0, exports.failure)(u, c)); }, exports.identity, value);
}
...
function keyof(keys, name) {
  ...
  return new KeyofType(name, is, function (u, c) { return (is(u)
    ? (0, exports.success)(u)
    : (0, exports.failure)(u, c)); }, exports.identity, keys);
}
exports.keyof = keyof;
// -------------------------------------------------------------------------------------
// combinators
...
function array(item, name) {
  ...
  return new ArrayType(name, function (u) { return exports.UnknownArray.is(u) && u.every(item.is); }, function (u, c) {
    ...
    return errors.length > 0
      ? (0, exports.failures)(errors)
      : (0, exports.success)(as);
  }, item.encode === exports.identity
    ? exports.identity
    : function (a) { return a.map(item.encode); }, item);
}
exports.array = array;
/**
 * @since 1.0.0
...
function intersection(codecs, name) {
  ...
  return new IntersectionType(name, function (u) { return codecs.every(function (type) { return type.is(u); }); }, codecs.length === 0
    ...
    : function (u, c) {
      ...
      return errors.length > 0
        ? (0, exports.failures)(errors)
        : (0, exports.success)(mergeAll(u, us));
    }, codecs.length === 0
    ? exports.identity
    : function (a) {
...
function tuple(codecs, name) {
  ...
  return new TupleType(name, function (u) { return exports.UnknownArray.is(u) && u.length === len && codecs.every(function (type, i) { return type.is(u[i]); }); }, function (u, c) {
    ...
    var us = e.right;
    var as = us.length > len
      ? us.slice(0, len)
      : us; // strip additional components
    var errors = [];
    for (var i = 0; i < len; i++) {
      var a = us[i];
      var type_3 = codecs[i];
    ...
    ? exports.identity
    : function (a) { return codecs.map(function (type, i) { return type.encode(a[i]); }); }, codecs);
}
exports.tuple = tuple;
/**
 * @since 1.0.0
...
var FunctionType = /** @class */ (function (_super) {
  ...
  function FunctionType() {
    var _this = _super.call(this, "Function",
      // tslint:disable-next-line:strict-type-predicates
      function (u) { return typeof u === "function"; }, function (u, c) { return (_this.is(u)
        ? (0, exports.success)(u)
        : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
...
var ObjectType = /** @class */ (function (_super) {
  ...
  function ObjectType() {
    var _this = _super.call(this, "object", function (u) { return u !== null && typeof u === "object"; }, function (u, c) { return (_this.is(u)
      ? (0, exports.success)(u)
      : (0, exports.failure)(u, c)); }, exports.identity) || this;
    /**
         * @since 1.0.0
