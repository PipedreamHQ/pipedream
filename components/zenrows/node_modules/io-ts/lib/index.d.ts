 ...
 * @since 1.0.0
 */
export type Mixed = Type<any, any, unknown>;
/**
 * @category Codec
 * @since 1.0.0
 */
 ...
 * @since 1.1.0
 */
export type HasPropsRefinement = RefinementType<HasProps, any, any, any>;
/**
 * @since 1.1.0
 */
export type HasPropsReadonly = ReadonlyType<HasProps, any, any, any>;
/**
 * @since 1.1.0
 */
export type HasPropsIntersection = IntersectionType<Array<HasProps>, any, any, any>;
/**
 * @since 1.1.0
 */
 ...
 * @since 1.5.3
 */
export type UndefinedC = UndefinedType;
 ...
 * @since 1.5.3
 */
export type UnknownC = UnknownType;
/**
 * @category primitives
 * @since 1.5.0
 */
 ...
 * @since 1.5.3
 */
export type StringC = StringType;
/**
 * @category primitives
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type NumberC = NumberType;
/**
 * @category primitives
 * @since 1.0.0
 */
 ...
 * @since 2.1.0
 */
export type BigIntC = BigIntType;
/**
 * @category primitives
 * @since 2.1.0
 */
 ...
 * @since 1.5.3
 */
export type BooleanC = BooleanType;
/**
 * @category primitives
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type UnknownArrayC = AnyArrayType;
/**
 * @category primitives
 * @since 1.7.1
 */
 ...
 * @since 1.5.3
 */
export type UnknownRecordC = AnyDictionaryType;
/**
 * @category primitives
 * @since 1.7.1
 */
 ...
 * @since 1.5.3
 */
export type LiteralC<V extends LiteralValue> = LiteralType<V>;
/**
 ...
 * @since 1.8.1
 */
export type BrandC<C extends Any, B> = RefinementType<C, Branded<TypeOf<C>, B>, OutputOf<C>, InputOf<C>>;
/**
 ...
 * @since 1.5.3
 */
export type ArrayC<C extends Mixed> = ArrayType<C, Array<TypeOf<C>>, Array<OutputOf<C>>, unknown>;
/**
 * @category combinators
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type TypeC<P extends Props> = InterfaceType<
    P,
    {
      [K in keyof P]: TypeOf<P[K]>
    },
 ...
 * @since 1.5.3
 */
export type PartialC<P extends Props> = PartialType<
    P,
    {
      [K in keyof P]?: TypeOf<P[K]>
    },
 ...
 * @since 1.5.3
 */
export type RecordC<D extends Mixed, C extends Mixed> = DictionaryType<
    D,
    C,
    {
      [K in TypeOf<D>]: TypeOf<C>
 ...
 * @since 1.5.3
 */
export type UnionC<CS extends [Mixed, Mixed, ...Array<Mixed>]> = UnionType<CS, TypeOf<CS[number]>, OutputOf<CS[number]>, unknown>;
/**
 * @category combinators
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type IntersectionC<CS extends [Mixed, Mixed, ...Array<Mixed>]> = IntersectionType<
    CS,
    CS extends {
      length: 2;
    }
 ...
 * @since 1.5.3
 */
export type TupleC<CS extends [Mixed, ...Array<Mixed>]> = TupleType<
    CS,
    CS extends {
      length: 1;
    }
 ...
 * @since 1.5.3
 */
export type ReadonlyC<C extends Mixed> = ReadonlyType<C, Readonly<TypeOf<C>>, Readonly<OutputOf<C>>, unknown>;
/**
 * @category combinators
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type ReadonlyArrayC<C extends Mixed> = ReadonlyArrayType<C, ReadonlyArray<TypeOf<C>>, ReadonlyArray<OutputOf<C>>, unknown>;
/**
 * @category combinators
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type ExactC<C extends HasProps> = ExactType<C, TypeOf<C>, OutputOf<C>, InputOf<C>>;
/**
 ...
 * @since 1.5.3
 */
export type FunctionC = FunctionType;
/**
 * @category primitives
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export type RefinementC<C extends Any, B = TypeOf<C>> = RefinementType<C, B, OutputOf<C>, InputOf<C>>;
/**
 * @category combinators
 * @since 1.0.0
 */
 ...
 * @deprecated
 */
export type TaggedUnionC<Tag extends string, CS extends [Mixed, Mixed, ...Array<Mixed>]> = TaggedUnionType<Tag, CS, TypeOf<CS[number]>, OutputOf<CS[number]>, unknown>;
/**
 * Use `union` instead.
 *
 * @category combinators
 ...
 * @deprecated
 */
export type ObjectC = ObjectType;
/**
 * Use `UnknownRecord` instead.
 *
 * @category primitives
 ...
 * @deprecated
 */
export type StrictC<P extends Props> = StrictType<
    P,
    {
      [K in keyof P]: TypeOf<P[K]>
    },
 ...
 * @deprecated
 */
export type TaggedRefinement<Tag extends string, A, O = A> = RefinementType<Tagged<Tag>, A, O>;
/**
 * @since 1.3.0
 * @deprecated
 */
export type TaggedUnion<Tag extends string, A, O = A> = UnionType<Array<Tagged<Tag>>, A, O>;
/**
 * @since 1.3.0
 * @deprecated
 */
 ...
 * @deprecated
 */
export type TaggedIntersection<Tag extends string, A, O = A> = IntersectionType<TaggedIntersectionArgument<Tag>, A, O>;
/**
 * @since 1.3.0
 * @deprecated
 */
export type TaggedExact<Tag extends string, A, O = A> = ExactType<Tagged<Tag>, A, O>;
/**
 * @since 1.3.0
 * @deprecated
 */
