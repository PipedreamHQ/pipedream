...
function fromRefinement(M) {
  return function (refinement, onError) { return ({
    decode: function (i) { return (refinement(i)
      ? M.of(i)
      : M.throwError(onError(i))); },
  }); };
}
...
function literal(M) {
  return function (onError) {
    return function () {
      ...
      return ({
        decode: function (i) { return (G.literal.apply(G, values).is(i)
          ? M.of(i)
          : M.throwError(onError(i, values))); },
      });
    };
  };
}
 ...
 */
function parse(M) {
  return function (decode) { return function (from) { return compose(M)({
    decode: decode,
  })(from); }; };
}
exports.parse = parse;
