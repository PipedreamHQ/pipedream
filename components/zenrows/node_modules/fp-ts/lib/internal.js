...
// -------------------------------------------------------------------------------------
/** @internal */
var fromReadonlyNonEmptyArray = function (as) { return __spreadArray([
  as[0],
], as.slice(1), true); };
...
var liftNullable = function (F) {
  return function (f, onNullable) {
    return function () {
      ...
      return F.fromEither(o == null
        ? (0, exports.left)(onNullable.apply(void 0, a))
        : (0, exports.right)(o));
    };
  };
};
...
var liftOption = function (F) {
  return function (f, onNone) {
    return function () {
      ...
      var o = f.apply(void 0, a);
      return F.fromEither((0, exports.isNone)(o)
        ? (0, exports.left)(onNone.apply(void 0, a))
        : (0, exports.right)(o.value));
    };
  };
};
