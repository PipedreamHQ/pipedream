...
function getApply(S) {
  return {
    ...
    ap: function (fab, fa) { return [
      (0, exports.fst)(fab)((0, exports.fst)(fa)),
      S.concat((0, exports.snd)(fab), (0, exports.snd)(fa)),
    ]; },
  };
}
...
function getChainRec(M) {
  var chainRec = function (a, f) {
    ...
    return [
      s.right,
      M.concat(acc, (0, exports.snd)(result)),
    ];
  };
  var C = getChain(M);
  return {
...
var traverse = function (F) {
  return function (f) { return function (ta) { return F.map(f((0, exports.fst)(ta)), function (b) { return [
    b,
    (0, exports.snd)(ta),
  ]; }); }; };
};
...
var sequence = function (F) {
  return function (fas) {
    return F.map((0, exports.fst)(fas), function (a) { return [
      a,
      (0, exports.snd)(fas),
    ]; });
  };
