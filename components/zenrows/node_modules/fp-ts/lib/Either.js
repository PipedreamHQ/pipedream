 ...
 * @since 2.14.0
 */
exports.flatMap = (0, function_1.dual)(2, function (ma, f) { return ((0, exports.isLeft)(ma)
  ? ma
  : f(ma.right)); });
...
var getShow = function (SE, SA) { return ({
  show: function (ma) { return ((0, exports.isLeft)(ma)
...
var getSemigroup = function (S) { return ({
  concat: function (x, y) { return ((0, exports.isLeft)(y)
    ? x
    : (0, exports.isLeft)(x)
      ? y
...
var getCompactable = function (M) {
  ...
  return {
    URI: exports.URI,
    _E: undefined,
    compact: function (ma) { return ((0, exports.isLeft)(ma)
      ? ma
      : ma.right._tag === "None"
        ? empty
  ...
  return {
    ...
    partitionMap: function (ma, f) {
      ...
      return (0, exports.isLeft)(e)
        ...
        : (0, Separated_1.separated)(empty, (0, exports.right)(e.right));
    },
  };
};
...
var extend = function (f) { return function (wa) {
  return (0, exports.isLeft)(wa)
    ? wa
    : (0, exports.right)(f(wa));
}; };
 ...
 * @since 2.0.0
 */
var swap = function (ma) { return ((0, exports.isLeft)(ma)
