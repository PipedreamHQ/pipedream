...
import {
  HKT, Kind, Kind2, Kind3, Kind4, URIS, URIS2, URIS3, URIS4,
} from "./HKT";
import {
  Monad, Monad1, Monad2, Monad2C, Monad3, Monad3C, Monad4,
} from "./Monad";
import * as O from "./Option";
import {
  Pointed, Pointed1, Pointed2, Pointed2C, Pointed3, Pointed3C, Pointed4,
} from "./Pointed";
 ...
 * @deprecated
 */
export type OptionT<M, A> = HKT<M, Option<A>>;
/**
 * @category zone of death
 * @since 2.0.0
 * @deprecated
