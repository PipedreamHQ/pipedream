 ...
 */
function toArray(O) {
  return collect(O)(function (k, a) { return [
    k,
    a,
  ]; });
}
...
function toUnfoldable(ord, U) {
  ...
  return function (d) {
    var kas = toArrayO(d);
    var len = kas.length;
    return U.unfold(0, function (b) { return (b < len
      ? _.some([
        kas[b],
        b + 1,
      ])
...
function pop(E) {
  ...
  return function (k) {
    ...
    return function (m) {
      return (0, function_1.pipe)(lookupE(k, m), O.map(function (a) { return [
        a,
        deleteAtEk(m),
      ]; }));
    };
 ...
 * @since 2.0.0
 */
var singleton = function (k, a) { return new Map([
  [
    k,
    a,
  ],
...
var getFoldable = function (O) {
  return __assign(__assign({}, RM.getFoldable(O)), {
    URI: exports.URI,
  });
};
...
var getFoldableWithIndex = function (O) {
  return __assign(__assign({}, RM.getFoldableWithIndex(O)), {
    URI: exports.URI,
  });
};
