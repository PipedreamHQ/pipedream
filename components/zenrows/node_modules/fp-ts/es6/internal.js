...
/** @internal */
export var some = function (a) { return ({
  _tag: "Some",
  value: a,
}); };
// -------------------------------------------------------------------------------------
...
/** @internal */
export var left = function (e) { return ({
  _tag: "Left",
  left: e,
}); };
/** @internal */
export var right = function (a) { return ({
  _tag: "Right",
  right: a,
}); };
// -------------------------------------------------------------------------------------
...
// -------------------------------------------------------------------------------------
/** @internal */
export var singleton = function (a) { return [
  a,
]; };
/** @internal */
...
// -------------------------------------------------------------------------------------
/** @internal */
export var fromReadonlyNonEmptyArray = function (as) { return __spreadArray([
  as[0],
], as.slice(1), true); };
/** @internal */
  ...
  return function (f, onNullable) {
    return function () {
      ...
      return F.fromEither(o == null
        ? left(onNullable.apply(void 0, a))
        : right(o));
    };
  };
};
...
export var liftOption = function (F) {
  return function (f, onNone) {
    return function () {
      ...
      var o = f.apply(void 0, a);
      return F.fromEither(isNone(o)
        ? left(onNone.apply(void 0, a))
        : right(o.value));
    };
  };
};
