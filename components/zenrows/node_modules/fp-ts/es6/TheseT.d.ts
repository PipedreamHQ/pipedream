 ...
 */
import {
  Apply, Apply1, Apply2, Apply2C, Apply3, Apply3C,
} from "./Apply";
import {
  Chain, Chain1, Chain2, Chain2C, Chain3, Chain3C,
} from "./Chain";
import { LazyArg } from "./function";
import {
  Functor, Functor1, Functor2, Functor2C, Functor3, Functor3C,
} from "./Functor";
import {
  HKT, Kind, Kind2, Kind3, URIS, URIS2, URIS3,
} from "./HKT";
import {
  Monad, Monad1, Monad2, Monad2C, Monad3, Monad3C,
} from "./Monad";
import {
  Pointed, Pointed1, Pointed2, Pointed2C, Pointed3, Pointed3C,
} from "./Pointed";
 ...
 * @deprecated
 */
export type TheseT<M, E, A> = HKT<M, These<E, A>>;
/**
 * @category zone of death
 * @since 2.4.0
 * @deprecated
