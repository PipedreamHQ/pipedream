...
export function of(F) {
  return function (a) { return function (s) { return F.of([
    a,
    s,
  ]); }; };
}
...
export function fromF(F) {
  return function (ma) { return function (s) { return F.map(ma, function (a) { return [
    a,
    s,
  ]; }); }; };
}
...
export function getStateM(M) {
  ...
  return {
    ...
    get: function () { return function (s) { return M.of([
      s,
      s,
    ]); }; },
    put: function (s) { return function () { return M.of([
      undefined,
      s,
    ]); }; },
    modify: function (f) { return function (s) { return M.of([
      undefined,
      f(s),
    ]); }; },
    gets: function (f) { return function (s) { return M.of([
      f(s),
      s,
    ]); }; },
