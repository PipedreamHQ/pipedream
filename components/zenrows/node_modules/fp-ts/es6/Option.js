...
import {
  apFirst as apFirst_, apS as apS_, apSecond as apSecond_, getApplySemigroup as getApplySemigroup_,
} from "./Apply";
import * as chainable from "./Chain";
import {
  chainEitherK as chainEitherK_, fromEitherK as fromEitherK_, tapEither as tapEither_,
} from "./FromEither";
import {
  constNull, constUndefined, dual, flow, identity, pipe,
} from "./function";
import {
  as as as_, asUnit as asUnit_, bindTo as bindTo_, flap as flap_, let as let__,
} from "./Functor";
 ...
 * @since 2.0.0
 */
export var getLeft = function (ma) { return (ma._tag === "Right"
  ? none
  : some(ma.left)); };
/**
 ...
 * @since 2.0.0
 */
export var getRight = function (ma) { return (ma._tag === "Left"
  ? none
  : some(ma.right)); };
...
export var getShow = function (S) { return ({
  show: function (ma) { return (isNone(ma)
    ? "none"
...
export var getEq = function (E) { return ({
  equals: function (x, y) { return x === y || (isNone(x)
    ? isNone(y)
    : isNone(y)
      ? false
...
export var getMonoid = function (S) { return ({
  concat: function (x, y) { return (isNone(x)
    ? y
    : isNone(y)
      ? x
 ...
 * @since 2.14.0
 */
export var flatMap = /*#__PURE__*/ dual(2, function (ma, f) { return (isNone(ma)
  ? none
  : f(ma.value)); });
/**
 * @category instances
 ...
 * @since 2.16.0
 */
export var orElse = dual(2, function (self, that) { return (isNone(self)
  ? that()
  : self); });
/**
 * Alias of `orElse`.
...
export var separate = function (ma) {
  return isNone(ma)
    ? defaultSeparated
    : separated(getLeft(ma.value), getRight(ma.value));
};
/**
 * @category instances
 * @since 2.7.0
 ...
 * @since 2.0.0
 */
export var fromNullable = function (a) { return (a == null
  ? none
  : some(a)); };
/**
...
export var traverseReadonlyArrayWithIndex = function (f) {
  ...
  return function (as) { return (_.isNonEmpty(as)
    ? g(as)
    : ApT); };
};
/**
