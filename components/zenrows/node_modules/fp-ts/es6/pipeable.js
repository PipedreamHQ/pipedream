import {
  apFirst as apFirst_, apSecond as apSecond_,
} from "./Apply";
import { chainFirst as chainFirst_ } from "./Chain";
import {
  identity, pipe as pipeFromFunctionModule,
} from "./function";
  ...
  if (isMonadThrow(I)) {
    ...
    var fromPredicate = function (predicate, onFalse) {
      return function (a) {
        return predicate(a)
          ? I.of(a)
          : I.throwError(onFalse(a));
      };
    };
    var filterOrElse = function (predicate, onFalse) {
      return function (ma) {
        return I.chain(ma, function (a) { return (predicate(a)
          ? I.of(a)
          : I.throwError(onFalse(a))); });
      };
    };
