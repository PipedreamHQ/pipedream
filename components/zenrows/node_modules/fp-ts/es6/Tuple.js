 ...
 * @since 2.0.0
 */
export var swap = function (ea) { return [
  snd(ea),
  fst(ea),
]; };
/**
 ...
 * @since 2.0.0
 */
export var mapFst = function (f) { return function (fa) { return [
  f(fst(fa)),
  snd(fa),
]; }; };
/**
 ...
 * @since 2.10.0
 */
export var mapSnd = function (f) { return function (fa) { return [
  fst(fa),
  f(snd(fa)),
]; }; };
/**
...
export var traverse = function (F) {
  return function (f) { return function (ta) { return F.map(f(fst(ta)), function (b) { return [
    b,
    snd(ta),
  ]; }); }; };
};
...
export var sequence = function (F) {
  return function (fas) {
    return F.map(fst(fas), function (a) { return [
      a,
      snd(fas),
    ]; });
  };
