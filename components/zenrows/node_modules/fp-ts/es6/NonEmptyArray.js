 ...
 * @since 2.0.0
 */
export var fromArray = function (as) { return (isNonEmpty(as)
  ? _.some(as)
  : _.none); };
/**
...
export var range = function (start, end) {
  return start <= end
    ? makeBy(function (i) { return start + i; })(end - start + 1)
    : [
      start,
    ];
};
 ...
 * @since 2.9.0
 */
export var unprepend = function (as) { return [
  head(as),
  tail(as),
]; };
/**
 ...
 * @since 2.9.0
 */
export var unappend = function (as) { return [
  init(as),
  last(as),
]; };
 ...
 * @since 2.0.0
 */
export var reverse = function (as) { return __spreadArray([
  last(as),
...
export var intersperse = function (middle) {
  return function (as) {
    var rest = tail(as);
    return isNonEmpty(rest)
      ? pipe(rest, prependAll(middle), prepend(head(as)))
      : copy(as);
  };
};
/**
...
export var splitAt = function (n) {
  return function (as) {
    ...
    return m >= as.length
      ...
      : [
        pipe(as.slice(1, m), prepend(head(as))),
        as.slice(m),
      ];
  };
};
