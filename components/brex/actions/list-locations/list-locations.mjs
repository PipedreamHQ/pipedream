...
export default {
  ...
  async run({ $ }) {
    const {
      items, truncated,
    } = await this.brexApp.listLocationsPaginated({
      $,
      max: this.maxResults,
    });
