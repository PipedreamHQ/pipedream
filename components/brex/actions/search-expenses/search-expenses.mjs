...
export default {
  ...
  props: {
    ...
    purchasedAtStart: {
      ...
      description: "Only return expenses purchased on or after this date-time, in [RFC 3339](https://tools.ietf.org/html/rfc3339#section-5.6) format, e.g. `2024-01-01T00:00:00.000Z`.",
      optional: true,
    },
    purchasedAtEnd: {
      type: "string",
      label: "Purchased At End",
      description: "Only return expenses purchased on or before this date-time, in [RFC 3339](https://tools.ietf.org/html/rfc3339#section-5.6) format, e.g. `2024-01-31T23:59:59.999Z`.",
      optional: true,
    },
    userIds: {
      propDefinition: [
