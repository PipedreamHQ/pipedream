...
export default {
  ...
  name: "Get Team",
  description: "Get the team associated with the provided API key. [See the documentation](https://docs.usebrainbase.com/api-reference/team/get-the-team-associated-with-the-provided-api-key)",
  version: "0.0.1",
  type: "action",
  annotations: {
