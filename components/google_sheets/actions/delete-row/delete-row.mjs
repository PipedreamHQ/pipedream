...
export default {
  ...
  name: "Delete Row",
  description: "Deletes a specific row in a spreadsheet. [See the documentation](https://developers.google.com/sheets/api/reference/rest/v4/spreadsheets.values/batchUpdate)",
  version: "0.1.3",
  type: "action",
  props: {
    googleSheets,
