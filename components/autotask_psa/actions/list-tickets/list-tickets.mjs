...
export default {
  ...
  name: "List Tickets",
  description:
    "List tickets from Autotask PSA using a query object. [See the documentation](https://www.autotask.net/help/developerhelp/Content/APIs/REST/REST_API_Home.htm)",
  version: "0.0.2",
  type: "action",
  annotations: {
  ...
  async run({ $ }) {
    ...
    $.export(
      "$summary",
      typeof n === "number"
        ? `Retrieved ${n} ticket(s)`
        : "Retrieved tickets from Autotask PSA",
    );
    return result;
  },
};
