  ...
  propDefinitions: {
    listId: {
      ...
      async options ({ page }) {
        ...
        return payload.map(list => ({ label: list.name, value: list.id }));
      }
    },
    overwrite: {
      type: 'boolean',
