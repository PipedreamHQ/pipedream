...
export default {
  ...
  description: "Generate a shipping label for an order in a supported output format (`pdf` or `zpl`). Use this when an order is ready to ship and needs a carrier label, then use **List Shipping Labels** to enumerate the generated labels and **Download Shipping Label** to fetch the file. [See the documentation](https://api-v6.monta.nl/index.html#tag/Order/paths/~1order~1%7Bwebshoporderid%7D~1shippinglabels/post)",
  version: "0.0.1",
  type: "action",
  annotations: {
