...
export default {
  ...
  description:
    ...
    + " a name is resolved by scanning up to 5 pages (~5,000 channels) of the workspace's channel"
    + " list, which can be slow, and a valid channel beyond that bound will not be found. Slack only"
