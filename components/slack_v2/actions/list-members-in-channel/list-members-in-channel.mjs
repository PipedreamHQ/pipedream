...
export default {
  ...
  description: "Retrieve members of a channel. Accepts a channel ID (preferred — resolves instantly) or NAME (e.g. general or #general), resolved by scanning the workspace's channel list, which can be slow. [See the documentation](https://api.slack.com/methods/conversations.members)",
  version: "0.1.6",
  annotations: {
