...
- Aggregated queries cap the date range: **14 days** for heart rate, active minutes, and total calories; **90 days** for everything else. The actions validate this and tell you when a range is too wide.
