...
export default {
  ...
  description: "Emit new transaction by retrieving all transactions of the business paginated. [See Docs](https://docs.ramp.com/reference/rest/transactions)",
  version: "0.0.1",
  type: "source",
  dedupe: "unique",
  props: {
  ...
  async run({ $ }) {
    ...
    const transactions = await this.ramp.listTransactionsPaginated(
      $,
      this.state,
