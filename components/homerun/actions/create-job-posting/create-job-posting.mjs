...
export default {
  key: "homerun-create-job-posting",
  name: "Create Job Posting",
  description: "Creates a new job posting. [See the documentation](https://developers.homerun.co/#tag/Job-Applications/operation/job-applications.post).",
  version: "0.0.1",
  type: "action",
  props: {
    app,
    ...
    facebook: {
      type: "string",
      label: "Facebook",
      description: "The Facebook URL of the applicant.",
      optional: true,
    },
    twitter: {
      type: "string",
    ...
    linkedin: {
      type: "string",
      label: "LinkedIn",
      description: "The LinkedIn URL of the applicant.",
      optional: true,
    },
    github: {
      type: "string",
      label: "GitHub",
      description: "The GitHub URL of the applicant.",
      optional: true,
    },
    website: {
      type: "string",
      label: "Website",
      description: "The website URL of the applicant.",
      optional: true,
    },
  },
  methods: {
  ...
  async run({ $ }) {
    ...
    $.export("$summary", "Successfully created a job posting.");
    return response;
  },
};
