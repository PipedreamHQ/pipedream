...
export default {
  ...
  name: "List Who's Out",
  description: "List a date-sorted feed of employees who are out and company holidays for a period. Returns 403 if the Who's Out feature is disabled for the account. [See the documentation](https://documentation.bamboohr.com/reference/list-whos-out)",
  version: "0.0.1",
  type: "action",
  annotations: {
