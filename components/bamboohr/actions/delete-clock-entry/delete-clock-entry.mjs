...
export default {
  ...
  description: "Permanently delete a clock entry. Idempotent (returns 204); returns 409 if the entry belongs to an approved timesheet or is still open. Use **List Clock Entries** to find IDs. [See the documentation](https://documentation.bamboohr.com/reference/delete-clock-entry)",
  version: "0.0.1",
  type: "action",
  annotations: {
