...
export default {
  ...
  description: "List all non-deleted company time off policies, sorted alphabetically by name. Each policy is `accruing`, `discretionary`, or `manual` and links to a time off type. Use **List Time Off Types** for the type-level metadata; use **Adjust Time Off Balance** to modify balances for the type a policy is tied to. [See the documentation](https://documentation.bamboohr.com/reference/list-time-off-policies)",
  version: "0.0.1",
  type: "action",
  annotations: {
