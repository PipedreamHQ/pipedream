...
export default {
  ...
  description: "Get the company employee directory from BambooHR (GET /employees/directory). Returns the company-configured fieldset for every employee; filter client-side. Use this to discover employee IDs before calling **Get Employee**, **Update Employee**, or time-tracking actions. [See the documentation](https://documentation.bamboohr.com/reference/get-employees-directory)",
  version: "0.0.1",
  type: "action",
  annotations: {
