...
export default {
  ...
  description: "Create a new employee. `firstName` and `lastName` are required; any other valid writable field can be supplied via Additional Fields. Returns a Location header with the new employee ID. [See the documentation](https://documentation.bamboohr.com/reference/create-employee)",
  version: "0.0.1",
  type: "action",
  annotations: {
