...
export default {
  ...
  description: "List active company time off types plus the default hours-per-day. Use the returned type IDs with **Create Time Off Request** and **List Time Off Requests**. [See the documentation](https://documentation.bamboohr.com/reference/list-time-off-types)",
  version: "0.0.1",
  type: "action",
  annotations: {
