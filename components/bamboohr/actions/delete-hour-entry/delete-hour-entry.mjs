...
export default {
  ...
  description: "Permanently delete a time-tracking hour entry. Idempotent (returns 204); returns 409 if the entry belongs to an approved timesheet. Use **List Hour Entries** to find IDs. [See the documentation](https://documentation.bamboohr.com/reference/delete-hour-entry)",
  version: "0.0.1",
  type: "action",
  annotations: {
