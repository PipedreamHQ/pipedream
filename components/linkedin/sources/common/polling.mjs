...
import app from "../../linkedin.app.mjs";
...
export default {
  ...
  methods: {
    ...
    setPersonId(value) {
      this.db.set(constants.PERSON_ID, value);
    },
    getPersonId() {
      return this.db.get(constants.PERSON_ID);
    },
    setOrganizationId(value) {
      this.db.set(constants.ORG_ID, value);
    },
    getOrganizationId() {
      return this.db.get(constants.ORG_ID);
    },
    setIsFirstRun(value) {
