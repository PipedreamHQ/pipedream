...
export default {
  ...
  description: "Returns general information about the Jira Data Center instance, including version, base URL, and deployment type. [See the documentation](https://developer.atlassian.com/server/jira/platform/rest-apis/)",
  version: "0.0.1",
  type: "action",
  annotations: {
