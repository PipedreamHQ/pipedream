...
export default {
  ...
  name: "Upload Media",
  description: "Upload an audio or video file for transcription and natural language processing into Speak AI. [See the documentation](https://docs.speakai.co/api/media/#post-media-upload).",
  version: "0.0.3",
  annotations: {
