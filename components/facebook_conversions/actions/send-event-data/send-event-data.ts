...
export default defineAction({
  ...
  props: {
    ...
    userData: {
      type: "object",
      label: "User Data",
      description: `A map that contains customer information data. ${GET_DOCS_URL(
        "user-data",
      )}`,
    },
    actionSource: {
    ...
    customData: {
      type: "object",
      label: "Custom Data",
      description: `A map that includes additional business data about the event. ${GET_DOCS_URL(
        "custom-data",
      )}`,
      optional: true,
    },
