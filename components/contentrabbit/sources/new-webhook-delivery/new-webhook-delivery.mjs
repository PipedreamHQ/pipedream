...
export default {
  ...
  description: "Emit new event when Content Rabbit delivers a webhook to your endpoint. [See the documentation](https://contentrabbitai.com/api/public/v1/docs#/Webhooks/listWebhookDeliveries)",
  version: "0.0.3",
  type: "source",
  dedupe: "unique",
  props: {
