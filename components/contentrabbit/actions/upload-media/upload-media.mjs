...
export default {
  ...
  description: "Create a direct-upload URL for Cloudflare Images. Upload a file to the returned `uploadURL`, then use the **Register Uploaded Image** action with the returned `cloudflareImageId` to add it to your media library. [See the documentation](https://contentrabbitai.com/api/public/v1/docs#/Media/createUploadUrl)",
  version: "0.0.3",
  type: "action",
  props: {
    contentRabbitApp,
  ...
  async run({ $ }) {
    ...
    const { uploadURL, id: cloudflareImageId } = uploadUrlResponse.data ?? {};
