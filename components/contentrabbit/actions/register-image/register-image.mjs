...
export default {
  ...
  description: "Register an image in the media library after it has been uploaded to the Cloudflare Images `uploadURL` returned by **Create Media Upload URL**. [See the documentation](https://contentrabbitai.com/api/public/v1/docs#/Media/createImage)",
  version: "0.0.1",
  type: "action",
  props: {
    contentRabbitApp,
