...
export default {
  ...
  name: "Update Post",
  description: "Partially update a post. Only provided fields are changed. [See the documentation](https://contentrabbitai.com/api/public/v1/docs#/Posts/updatePost)",
  version: "0.0.1",
  type: "action",
  props: {
    contentRabbitApp,
