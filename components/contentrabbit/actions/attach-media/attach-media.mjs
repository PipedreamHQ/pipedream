...
export default {
  ...
  description: "Attach one or more media items to a post's platform settings. [See the documentation](https://contentrabbitai.com/api/public/v1/docs#/Posts/updatePost)",
  version: "0.0.3",
  type: "action",
  props: {
    contentRabbitApp,
  ...
  async run({ $ }) {
    ...
    const platformSettings = { ...(post?.platformSettings ?? {}) };
