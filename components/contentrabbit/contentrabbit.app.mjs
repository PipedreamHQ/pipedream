...
export default {
  ...
  methods: {
    ...
    async schedulePost({ postId, ...opts } = {}) {
      return this._makeRequest({
    ...
    async unschedulePost({ postId, ...opts } = {}) {
      return this._makeRequest({
        path: `/posts/${postId}/schedule`,
        method: "DELETE",
        ...opts,
    ...
    // ─── Media ────────────────────────────────────────────────────
    async listMedia({ type = "images", ...opts } = {}) {
      return this._makeRequest({
        path: `/media/${type}`,
        ...opts,
      });
