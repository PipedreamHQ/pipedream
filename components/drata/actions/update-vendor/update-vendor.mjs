...
const docsLink = "https://developers.drata.com/docs/openapi/reference/operation/VendorsPublicController_updateVendor/";
...
export default {
  ...
  async run({ $ }) {
    const response = await this.drata.updateVendor({
      $,
    ...
    $.export("$summary", "Succesfully updated vendor");
    return response;
  },
};
