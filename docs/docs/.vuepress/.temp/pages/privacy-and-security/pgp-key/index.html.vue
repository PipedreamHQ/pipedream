<template><h1 id="pgp-key" tabindex="-1"><a class="header-anchor" href="#pgp-key" aria-hidden="true">#</a> PGP Key</h1>
<p>If you'd like to encrypt sensitive information in communications to Pipedream, use this PGP key.</p>
<ul>
<li>Key ID: <code>3C85BC49602873EB</code></li>
<li>Fingerprint: <code>E0AD ABAC 0597 5F51 8BF5 3ECC 3C85 BC49 6028 73EB</code></li>
<li>User ID: <code>Pipedream Security &lt;security@pipedream.com&gt;</code></li>
</ul>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>-----BEGIN PGP PUBLIC KEY BLOCK-----
