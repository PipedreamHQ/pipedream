...
When you're first learning how Pipedream works, you can trigger a workflow using this test event to learn how [code](/code/), [actions](/components/actions/), [destinations](/destinations/), and other functionality works.
