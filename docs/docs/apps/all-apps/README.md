...
- [Calendly (OAuth)](https://calendly.com)
...
- [Dynamics 365 Business Central API](https://dynamics.microsoft.com/en-us/business-central/overview/)
...
- [Ghost.org (Admin API)](https://ghost.io)
...
- [ServerAvatar](https://serveravatar.com)
