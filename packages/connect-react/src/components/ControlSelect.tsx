...
export function ControlSelect<T>({ isCreatable, options, selectProps }: ControlSelectProps<T>) {
  ...
  const MaybeCreatableSelect = isCreatable ? CreatableSelect : Select
  return (
