...
Specifically, you'll need to generate a component that receives webhooks from a third-party API for new data, processing and emitting new records as events.
