...
When developing workflows with pre-built actions and triggers, under the hood you're using [components](/contributing/components/) from the [Pipedream Registry Github Repository](https://github.com/PipedreamHQ/pipedream).
...
If you haven't yet, we recommend starting with our Component Development Quickstart Guides for [sources](/contributing/components/quickstart/nodejs/sources/)
and [actions](/contributing/components/actions-quickstart/) to learn how to build components and privately publish them to your account.
</Callout>
...
Anyone from the community can build [sources](/workflows/building-workflows/triggers/) and [actions](/contributing/components/#actions) for integrated apps.
...
4. Address any feedback provided by Pipedream based on the best practice [Component Guidelines & Patterns](/contributing/components/guidelines/).
