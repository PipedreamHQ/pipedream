...
Registry [components](/contributing/components/api/#component-structure) require a unique
...
library](/contributing/components/api/#using-npm-packages), feel free to use that instead of
...
[secret](/contributing/components/api/#general) props.
...
definitions](/contributing/components/api/#prop-definitions-example).
...
Whenever possible, reuse [methods](/contributing/components/api/#methods) defined in the app
...
Use [prop](/contributing/components/api/#user-input-props) labels to customize the name of a
...
Include a description for [props](/contributing/components/api/#user-input-props) if it helps
...
Use optional [props](/contributing/components/api/#user-input-props) whenever possible to
...
Provide [default values](/contributing/components/api/#user-input-props) whenever possible.
...
options](/contributing/components/api/#async-options-example) (with label/value definitions)
...
[pagination](/contributing/components/api/#async-options-example) (so users can navigate
...
[Dynamic props](/contributing/components/api/#dynamic-props) can improve the user experience
...
[interface](/contributing/components/api/#interface-props) and
[service](/contributing/components/api/#service-props) props in source components:
...
Always [emit a summary](/contributing/components/api/#emit) for each event. For example, the
...
Use built-in [deduping strategies](/contributing/components/api/#dedupe-strategies) whenever
...
[Hooks](/contributing/components/api/#hooks) are methods that are automatically invoked by
Pipedream at different stages of the [component
lifecycle](/contributing/components/api/#source-lifecycle). Webhook subscriptions are
...
deleting webhook subscriptions](/contributing/components/api/#hooks).
...
[Describe what happened](/contributing/components/api/#returning-data-from-steps) when an
