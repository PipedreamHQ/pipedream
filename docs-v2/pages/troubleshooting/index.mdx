...
Often, this occurs when you pass large data between steps using [step exports](/core/#step-exports). You can avoid this error by [writing that data to the `/tmp` directory](/core/workflows/code/nodejs/working-with-files/#writing-a-file-to-tmp) in one step, and [reading the data into another step](/core/workflows/code/nodejs/working-with-files/#reading-a-file-from-tmp), which avoids the use of step exports and should keep you under the payload limit.
