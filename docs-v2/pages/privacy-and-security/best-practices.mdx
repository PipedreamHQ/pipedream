...
- [If Pipedream integrates with the app](https://pipedream.com/apps), use [connected accounts](/workflows/integrations/connected-accounts/) to link your apps / APIs.
...
For many workflows, you should [configure authorization](/docs/workflows/visual-builder/triggers#authorizing-http-requests) to ensure that only authorized parties can invoke your HTTP trigger.
