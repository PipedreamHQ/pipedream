...
![Create Task Scheduler](./images/create-task-scheduler.gif)
...
![Find Task Scheduler step](./images/find-task-scheduler-step.gif)

Visit the Task Scheduler source you created in **Step 1** and copy its **Endpoint**:

![Task Scheduler endpoint](./images/endpoint.png)
...
![Configured task scheduler step](./images/configured-task-scheduler-step.png)
...
![Select Task Scheduler source](./images/select-task-scheduler-as-trigger.gif)
...
![Task Scheduler event data](./images/task-scheduler-event.png)
...
![event.message.email reference](./images/task-scheduler-event.png)

Finally, toggle your trigger step **On**:

![Toggle trigger step on](./images/toggle-trigger-step-on.gif)
