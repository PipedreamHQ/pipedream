...
List all connected accounts accessible by the authenticated user or workspace.
...
You can invoke workflows by making an HTTP request to a workflow's HTTP trigger. [See the docs on authorizing requests and invoking workflows](/workflows/triggers#authorizing-http-requests) for more detail.
