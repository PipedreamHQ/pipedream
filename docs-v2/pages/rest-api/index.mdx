...
The full code for a [Pipedream component](/contributing/components/api/).
...
slug](/contributing/components/api/#component-structure)
...
component](/contributing/components/api/).
...
If absent, this defaults to using the [name slug](/contributing/components/api/#component-structure)
of the component used to create the source.
...
See [the `this.$emit` docs](/contributing/components/api/#emit) for more information on how to emit events on custom channels.
