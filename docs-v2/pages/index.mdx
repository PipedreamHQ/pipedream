...
- [Develop custom actions](/contributing/components/actions-quickstart/)
- [Develop custom triggers](/contributing/components/quickstart/nodejs/sources/)
...
Pipedream maintains a [source-available component registry](https://github.com/PipedreamHQ/pipedream) on GitHub so you can avoid writing boilerplate code for common API integrations. Use components as no code building blocks in workflows, or use them to scaffold code that you can customize. You can also [create a PR to contribute new components](/contributing/#contribution-process) via GitHub.
...
- [Contributing components](/contributing/) to the [Pipedream registry](https://github.com/PipedreamHQ/pipedream) or sharing via your own GitHub repo
