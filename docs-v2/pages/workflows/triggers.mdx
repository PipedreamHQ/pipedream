...
![App triggers](/images/triggers/app-triggers.png)
...
![Google Calendar sources](/images/triggers/google-calendar-triggers.png)
...
![Add multiple triggers to a workflow](/images/triggers/add-multi-trigger.gif)
...
![Cron Scheduler source](/images/triggers/schedule.png)
...
<PipedreamImg alt="Email source" src="https://res.cloudinary.com/pipedreamin/image/upload/v1708323548/docs/email_clrdbg.png" width={500} height={600} />

Pipedream creates an email address specific to your workflow. Any email sent to this address triggers your workflow:

![Custom workflow email address](/images/triggers/email-addr.png)
...
<PipedreamImg alt="RSS source" src="https://res.cloudinary.com/pipedreamin/image/upload/v1708323587/docs/c1264873-969c-4f3a-9d4d-210b69ea9fa3.png" width={400} height={500} />
