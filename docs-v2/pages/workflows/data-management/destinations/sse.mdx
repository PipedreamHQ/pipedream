...
You can send data to an SSE Destination in [Node.js code steps](/workflows/visual-builder/code/nodejs/) using the `$.send.sse()` function.
...
![Pipeline ID](./images/pipeline-id.png)
