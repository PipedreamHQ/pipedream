...
If you're authoring a [component action](/contributing/components/#actions), you can send events to an SSE destination using `$.send.sse`.
...
![Pipeline ID](/images/destinations/pipeline-id.png)
