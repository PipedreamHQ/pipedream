...
You can emit arbitrary events from any [Node.js code steps](/workflows/visual-builder/code/nodejs/) using `$.send.emit()`.
...
This should trigger your listener, and you should see the same event in [the event inspector](/workflows/visual-builder/inspect/#the-inspector).
