...
You can send HTTP requests in [Node.js code steps](/workflows/visual-builder/code/nodejs/) using `$.send.http()`.
...
If you need to access the HTTP response data in your workflow, [use `axios`](/workflows/visual-builder/code/nodejs/http-requests/) or another HTTP client.
