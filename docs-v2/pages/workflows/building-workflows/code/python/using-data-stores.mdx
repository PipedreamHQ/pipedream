...
You can store and retrieve data from [Data stores](/core/data-management/data-stores/) in Python without connecting to a 3rd party database.
...
![Adding a data store to a Python step](https://res.cloudinary.com/pipedreamin/image/upload/v1710518388/docs/docs/core/workflows/code/pythondata-stores/CleanShot_2024-03-15_at_11.58.53_ognvbc.gif)
