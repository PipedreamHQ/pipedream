...
Use `$.flow.delay` to [delay a step in a workflow](/core/workflows/control-flow/delay/).

These docs show you how to write Node.js code to handle delays. If you don't need to write code, see [our built-in delay actions](/core/workflows/control-flow/delay/#delay-actions).
