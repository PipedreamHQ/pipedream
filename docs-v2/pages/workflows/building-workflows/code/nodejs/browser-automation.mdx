...
Yes, the same `@pipedream/browsers` package can be used in [actions](/contributing/components/actions-quickstart/) as well as [sources](/contributing/components/sources-quickstart/).
