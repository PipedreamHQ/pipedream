...
[Read the props reference for the full list of options](/contributing/components/api/#props).
...
This defines [a Node.js component](/contributing/components/api/). Components let you:
...
- You also have access to the `$` variable, which gives you access to methods like `$.respond`, `$.export`, [and more](/contributing/components/api/#actions).
