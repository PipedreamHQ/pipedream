...
Pipedream comes with thousands of prebuilt [triggers](/core/workflows/triggers/) and [actions](/core/contributing/components/#actions) for [hundreds of apps](https://pipedream.com/apps). Often, these will be sufficient for building simple workflows.
