...
- [Retrieve data from a data store](/workflows/visual-builder/code/pythonusing-data-stores/#retrieving-data)
- [Store data into a data store](/workflows/visual-builder/code/pythonusing-data-stores/#saving-data)
...
You can return HTTP responses from [HTTP-triggered workflows](/docs/workflows/visual-builder/triggers/#http) using the `pd.respond()` method:
...
<Callout type="info">
_Don't forget_ to [configure your workflow's HTTP trigger to allow a custom response](/docs/workflows/visual-builder/triggers/#http-responses). Otherwise your workflow will return the default response.
</Callout>
