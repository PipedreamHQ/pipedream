...
If you need [to use data from other steps](/workflows/visual-builder/code/python#using-data-from-another-step) or [export data to other steps](/workflows/visual-builder/code/python#sending-data-downstream-to-other-steps) in your workflow, we recommend using the `pipedream` package module.

If you need to use a Data Store in your workflow, we recommend using a [pre-built action](/data-stores/) to retrieve or store data or [Node.js's Data Store](/workflows/visual-builder/code/nodejs/using-data-stores/) capabilities.
