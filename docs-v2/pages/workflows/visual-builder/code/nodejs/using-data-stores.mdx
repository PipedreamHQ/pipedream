...
![Create a new data store or choose another one from your account for your component](./images/v3/workflows/visual-builder/code/nodejs/data-stores/nodejs-example.png)
...
Data Stores are only currently available in Node.js and Python steps. They are not yet available [Bash](/workflows/visual-builder/code/bash/) or [Go](/workflows/visual-builder/code/go/).
