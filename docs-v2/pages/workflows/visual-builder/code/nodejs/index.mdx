...
- [Issue HTTP responses](/workflows/visual-builder/triggers/#http-responses)
...
You can return HTTP responses from [HTTP-triggered workflows](/workflows/visual-builder/triggers/#http) using the [`$.respond()` function](/workflows/visual-builder/triggers/#http-responses).
