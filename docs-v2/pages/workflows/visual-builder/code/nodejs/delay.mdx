...
Use `$.flow.delay` to [delay a step in a workflow](/workflows/visual-builder/control-flow/delay).

These docs show you how to write Node.js code to handle delays. If you don't need to write code, see [our built-in delay actions](/workflows/visual-builder/control-flow/delay#delay-actions).
