...
![Generate code with AI](https://res.cloudinary.com/pipedreamin/image/upload/v1710515666/docs/docs/workflows/visual-builder/code/nodejs/ai-code-generation/CleanShot_2024-03-15_at_11.13.07_mjgmdc.gif)
...
![Use AI with the Slack API](./images/v3/workflows/visual-builder/code/nodejs/ai-code-generation/generating-slack-actions-with-ai.png)
...
![Edit code with AI](https://res.cloudinary.com/pipedreamin/image/upload/v1710515922/docs/docs/workflows/visual-builder/code/nodejs/ai-code-generation/CleanShot_2024-03-15_at_11.17.20_pumcgn.gif)
