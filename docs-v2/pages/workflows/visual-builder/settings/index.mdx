...
Even with data retention disabled on your workflow, the builder will still surface inbound events when in build mode. To avoid surfacing potentially sensitive data here as well, refer to [these docs](/docs/workflows/visual-builder/triggers/#pipedream-specific-request-parameters).
