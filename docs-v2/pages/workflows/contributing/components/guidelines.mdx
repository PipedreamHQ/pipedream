...
export](/core/#step-exports) for users to reference in future steps
...
2. Proxied execution of commands against a DB, which guarantees that such
   ...
   [shared static IPs docs](/core/data-management/databases#send-requests-from-a-shared-static-ip))
