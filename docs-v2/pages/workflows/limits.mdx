...
The following limits apply to [HTTP triggers](/docs/workflows/visual-builder/triggers/#http).
...
Currently, most of the [limits that apply to HTTP triggers](#http-triggers) also apply to [email triggers](/docs/workflows/visual-builder/triggers/#email).
