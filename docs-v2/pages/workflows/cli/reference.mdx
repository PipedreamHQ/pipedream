...
[Read more about authoring your own event sources](/contributing/components/quickstart/nodejs/sources/).
...
Creates a directory and [an app file](/contributing/components/guidelines/#app-files) from a template
...
Creates a new directory and [a component action](/contributing/components/#actions) from a template.
...
You can attach [database](/contributing/components/api/#db), [HTTP](/contributing/components/api/#http), or [Timer](/contributing/components/api/#timer) props to your template using the following flags:
