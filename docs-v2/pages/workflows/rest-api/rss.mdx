...
Here, we'll walk through an example of how to create an RSS [event source](/sources/) and retrieve events from that source using the [REST API](/workflows/rest-api/).
