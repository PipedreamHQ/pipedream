...
<Callout type="info">
The filters are scoped to the current [workspace](/core/workspaces/). If you're not seeing the events or workflow you're expecting, try [switching workspaces](/core/workspaces/#switching-between-workspaces).
</Callout>
