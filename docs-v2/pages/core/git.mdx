...
To resolve this error:
1. Make sure all the connected accounts in the project's workflows are [accessible to the entire workspace](/workflows/integrations/connected-accounts/#access-control)
