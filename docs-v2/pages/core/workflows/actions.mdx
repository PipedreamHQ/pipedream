...
Start with our [action development quickstart](/core/contributing/components/quickstart/nodejs/actions/). You can read more about all the capabilities of actions in [our API docs](/core/contributing/components/api/), and review [example actions here](/core/contributing/components/api/#example-components).

You can also publish actions to [the Pipedream registry](/core/contributing/), which makes them available for anyone on Pipedream to use.
