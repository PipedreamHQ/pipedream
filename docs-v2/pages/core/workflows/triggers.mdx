...
You can access properties of the HTTP request, like the method, payload, headers, and more, in [the `event` object](/core/workflows/triggers/#event-format), accessible in any [code](/code/) or [action](/workflows/contributing/components#actions) step.
