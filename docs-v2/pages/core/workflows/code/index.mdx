...
Pipedream comes with thousands of prebuilt [triggers](/workflows/steps/triggers/) and [actions](/workflows/contributing/components#actions) for [hundreds of apps](https://pipedream.com/apps). Often, these will be sufficient for building simple workflows.
...
<LanguageLink name="Node.js" link="/docs/core/workflows/code/nodejs/" icon={icons.nodejs.with_title} />
<LanguageLink name="Python" link="/docs/core/workflows/code/python" icon={icons.python.with_title} />
<LanguageLink name="Go" link="/docs/core/workflows/code/go/" icon={icons.go.with_title} />
<LanguageLink name="Bash" link="/docs/core/workflows/code/bash/" icon={icons.bash.with_title} />
</div>
