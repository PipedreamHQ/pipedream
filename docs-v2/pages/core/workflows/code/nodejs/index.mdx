...
A Node.js step can use data from other steps using [step exports](/core/#step-exports), it can also export data for other steps to use.
...
- Pipedream passes the `steps` variable to the run method. `steps` is also an object, and contains the [data exported from previous steps](/core/#step-exports) in your workflow.
