...
![trigger.gif](/images/control-flow/trigger.gif)
...
![add if else.gif](/images/control-flow/add_if_else.gif)
...
![add step to branch.gif](/images/control-flow/add_step_to_branch.gif)
...
![test end phase.gif](/images/control-flow/test_end_phase.gif)

Add a step and reference the exports from `ifelse` using the steps object.

![reference end exports.gif](/images/control-flow/reference_end_exports.gif)
