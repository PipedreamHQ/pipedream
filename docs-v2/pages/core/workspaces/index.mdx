...
3. You'll be prompted to name the workspace (you can [change the name later](/core/workspaces/#renaming-a-workspace))
...
2. Make sure you're in the [correct workspace](/core/workspaces/#switching-between-workspaces)
