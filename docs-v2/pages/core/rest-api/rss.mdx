...
Here, we'll walk through an example of how to create an RSS [event source](/core/workflows/triggers/) and retrieve events from that source using the [REST API]((/core/rest-api/).
