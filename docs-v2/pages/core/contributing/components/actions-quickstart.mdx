...
This document is intended for developers who want to author and edit [Pipedream Actions](/core/contributing/components/#actions). After completing this quickstart, you'll understand how to:
...
<Callout type="info">
If you previously developed actions using Pipedream's UI, we recommend reviewing our [migration guide](/core/contributing/components/migrating/) after completing this quickstart.
</Callout>

## Prerequisites

- Create a free account at [https://pipedream.com](https://pipedream.com)
- Download and install the [Pipedream CLI](/core/cli/install/)
- Once the CLI is installed, [link your Pipedream account](/core/cli/login/#existing-pipedream-account) to the CLI by running `pd login` in your terminal

> **NOTE:** See the [CLI reference](/core/cli/reference/) for detailed usage and examples beyond those covered below.
