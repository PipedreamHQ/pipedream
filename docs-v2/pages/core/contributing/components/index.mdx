...
Private action components published from the [CLI](/workflows/cli/reference/#pd-publish) or from a [Node.js Code Step](/core/workflows/code/nodejs/sharing-code) are available for use across your workflows.
