...
**Step 2.** [Download and install the Pipedream CLI](/core/cli/install/).

**Step 3.** Once the CLI is installed, [link your Pipedream account to the CLI](/core/cli/login/#existing-pipedream-account):
