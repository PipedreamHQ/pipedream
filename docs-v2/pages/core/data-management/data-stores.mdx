...
The **Key** must evaluate to a string. You can pass a static string, reference [exports](/core/#step-exports) from a previous step, or use [any valid expression](/core/workflows/using-props/#entering-expressions).
