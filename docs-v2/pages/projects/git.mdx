...
For example, if you modified a [registry action](https://pipedream.com/docs/apps/contributing) and published it to your workspace, the correct component key is `@workspacename/component-key@version` (e.g. `@pipedream/github-update-issue@0.1.0`).
