...
![Select SQL action](https://res.cloudinary.com/pipedreamin/image/upload/v1717126382/sql-actions-step-selector_b51u45.png)
...
### Explore the schema
- Connect your account and explore the database schema

### Write and execute your query
- Write your SQL query in the editor — read more about [prepared statements](#prepared-statements) above to leverage dynamic data in your query
