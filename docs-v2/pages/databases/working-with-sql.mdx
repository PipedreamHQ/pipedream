...
- Once you connect your account with one of the [supported database apps](/databases#supported-databases), we automatically fetch and display the details of the database schema below
...
To compare the prepared vs computed statement, click the toggle in the **Statements** tab:
