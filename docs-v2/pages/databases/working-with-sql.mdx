...
{/* - From the step selector, search for one of the database apps either **Execute MySQL Query** or **Execute PostgreSQL Query** */}

{/* ![Select the relevant SQL action](https://res.cloudinary.com/pipedreamin/image/upload/v1717782660/db-actions-step-selector_c2dkd2.svg) */}

- From the step selector in the builder, search for one of the [database apps where the SQL editor is supported](#supported-databases)
- Select the **Execute SQL Query** action
