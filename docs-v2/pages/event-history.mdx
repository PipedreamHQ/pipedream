...
- **Replay**: Replays the selected events. This is useful when you may have multiple errored events that you want to execute again.
- **Delete**: Deletes the selected events. This may be useful if you have certain events you want to scrub from the event history.
