...
![default axios stack trace](./images/default-axios-stack.png)
...
![pipedream axios success case](./images/pipedream-axios-success.png)
...
![pipedream axios error case](./images/pipedream-axios-stack.png)
