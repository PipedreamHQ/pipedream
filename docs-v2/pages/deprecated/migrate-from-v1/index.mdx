...
Allowing all of the scaffolding to be edited opens up the ability to [pass props](/workflows/visual-builder/code/nodejs/#passing-props-to-code-steps) into your Node.js code steps, which we'll cover later.
...
The `$checkpoint` functionality to save data between workflow runs is not supported in v2, and has been replaced by [Data Stores](/workflows/visual-builder/code/nodejs/using-data-stores/).
...
- `$checkpoint` has been removed from v2 workflows, but [Data Stores](/workflows/visual-builder/code/nodejs/using-data-stores/) provides a similar API.
