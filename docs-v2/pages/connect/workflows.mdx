...
When you configure [pre-built actions](/workflows/actions) or [custom code that connects to third-party APIs](/workflows/visual-builder/code/nodejs/auth), you can link accounts in one of two ways:
