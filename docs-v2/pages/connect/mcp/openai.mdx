...
3. You'll need to these inputs to get set up:
...
- You'll also define the `project_id` and `pipedream_environment` in you env once, then use the Pipedream SDK or REST API to get a fresh access token.