...
- Authorization to the Pipedream API failed when creating the Connect token.
- Double-check the client ID or secret for your [Pipedream OAuth client](/connect/api#authentication).
