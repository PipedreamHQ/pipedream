...
::: details A workflow that executes 2 times with {process.env.base_credits_price.seconds + 5 } seconds per run
...
::: details A polling source finishing under {process.env.base_credits_price.seconds } seconds per execution
...
::: details A polling source finishing over {process.env.base_credits_price.seconds } seconds per execution
...
::: details A custom source that finished under {process.env.base_credits_price.seconds } seconds per execution
