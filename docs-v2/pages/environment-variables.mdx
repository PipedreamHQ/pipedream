...
=======
You can reference the value of environment variables using <code>{process.env.YOUR_ENV_VAR}</code>. You'll see a list of your environment variables in the object explorer when selecting a variable to pass to a step.
